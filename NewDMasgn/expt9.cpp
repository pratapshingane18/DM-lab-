...
int main()
{
    ...
    vector<double> allData = readDataFromCSV("expt9_input.csv");
    ...
    if (correlation == 0)
    {
        cout << "No linear relationship between two variables" << endl;
    }
    else if (correlation > 0)
    {
        cout << "Positive correlation between two variables" << endl;
    }
    else
    {
        cout << "Negative correaltion between two variables" << endl;
    }
